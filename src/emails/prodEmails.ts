...
export const EMAILS: EmailTemplate[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      SP('20'),
      S('text', { text: 'Si desconoces esta actividad, por favor contáctanos inmediatamente a ((https://ayuda.vmcsubastas.com/es/|https://ayuda.vmcsubastas.com/es/))' }),
      SP('16'),
  ...
  },
  {
    ...
    sections: [
      ...
      SP('24'),
      S('text', { text: 'Ya puedes ver las ofertas ((aquí)).' }),
      SP('14'),
