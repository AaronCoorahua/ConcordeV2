...
/**
 * /blocks/register — Visor del bloque Register (en construcción: por ahora
 * solo el Header + heading de bienvenida, sin card detrás).
 */
...
const REQUIRED: RequiredItem[] = [
  { name: "Input", path: "/handoff/input", role: "Campos de Datos Personales (variantes default/focus/error)" },
  { name: "Button", path: "/handoff/button", role: "CTA «Sigamos» (primary, deshabilitado hasta aceptar los términos)" },
  { name: "TabSelector", path: "/handoff/tabselector", role: "Toggle Boleta/Factura en la card «Quiero Recibir»" },
  { name: "TermsSelector", path: "/handoff/termsselector", role: "Checkboxes de aceptación de términos y políticas" },
];

// Archivos propios del bloque
const BLOCK_FILES: BlockFile[] = [
  { path: "src/blocks/register/desktop/Register.tsx", code: readSrc("src/blocks/register/desktop/Register.tsx") },
  { path: "src/blocks/register/desktop/dimensions.ts", code: readSrc("src/blocks/register/desktop/dimensions.ts") },
  { path: "src/blocks/register/desktop/PersonalDataCard.tsx", code: readSrc("src/blocks/register/desktop/PersonalDataCard.tsx") },
  { path: "src/blocks/register/desktop/BillingCard.tsx", code: readSrc("src/blocks/register/desktop/BillingCard.tsx") },
  { path: "src/blocks/register/desktop/TermsAcceptance.tsx", code: readSrc("src/blocks/register/desktop/TermsAcceptance.tsx") },
  { path: "src/blocks/register/mobile/RegisterMobile.tsx", code: readSrc("src/blocks/register/mobile/RegisterMobile.tsx") },
  { path: "src/blocks/register/mobile/dimensions.ts", code: readSrc("src/blocks/register/mobile/dimensions.ts") },
];

// Componentes que usa el bloque
const USED_COMPONENTS = ["Input", "TabSelector", "TermsSelector", "EyeIcon"];
...
export default function RegisterBlockPage(): JSX.Element {
  return (
