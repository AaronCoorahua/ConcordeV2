    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", color: "var(--ui-ink)", fontFamily: "var(--vmc-font-display, 'Plus Jakarta Sans', -apple-system, sans-serif)" }}>
      ...
      <main style={{ maxWidth: 1120, margin: "0 auto", padding: "40px 40px 80px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8, flexWrap: "wrap" }}>
          <span style={{ fontSize: 13, fontWeight: 800, fontFamily: "monospace", minWidth: 26, height: 26, padding: "0 7px", borderRadius: 8, background: "var(--ui-accent-soft)", color: "var(--ui-accent)", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>{t.letra}</span>
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.02em", color: "var(--ui-ink)", margin: 0 }}>{t.label}</h1>
        ...
        <p style={{ fontSize: 14, color: "var(--ui-body)", lineHeight: 1.6, margin: "0 0 40px", maxWidth: 640 }}>
