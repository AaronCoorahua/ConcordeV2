...
/**
 * /correos/variantes — catálogo de correos reales en producción, agrupados por
 * tema (En vivo, Negociable, SubasCoins, Registro…). Cada card es un grupo con
 * el preview de su correo demo; dentro, las plantillas HTML estáticas.
 */
    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", color: "#0f172a", fontFamily: "var(--vmc-font-display, 'Plus Jakarta Sans', -apple-system, sans-serif)" }}>
      ...
      <main style={{ maxWidth: 1120, margin: "0 auto", padding: "40px 40px 80px" }}>
        ...
        <p style={{ fontSize: 14, color: "#64748b", lineHeight: 1.6, margin: "0 0 24px", maxWidth: 720 }}>
          Los correos que hoy existen en producción, agrupados por tema, con sus plantillas HTML
          estáticas email-safe (tablas + estilos inline, formato 600px). Cada card es un grupo;
          dentro están el banner header copiable y los correos completos.
        </p>
